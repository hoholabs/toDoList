...
function formatDate(date) {
    ...
    return (0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(date,'d MMM yy');
...
function editTask(taskId){
    ...
    let index = (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.findTask)(taskId)

    //get task data from tasklist
    let task = (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getTask)(index);
    ...
    thisDue.addEventListener('click', () => {
        thisDueCal.append((0,_calendar_js__WEBPACK_IMPORTED_MODULE_1__.createCalendar)(2022,1));
    }, { once: true });
    ...
    okBtn.addEventListener('click', function(){
        ...
        (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.changeTask)(index,'name',nameInput.value);
        (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.changeTask)(index,'desc',descInput.value);
        (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.changeTask)(index,'due',thisDue.firstChild.textContent);
        (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.changeTask)(index,'priority',thisTask.querySelector('.priority').textContent);
        ...
        (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.saveTaskList)();
...
function strikeoutTask(id){
    ...
    let index = (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.findTask)(id);
    let task = (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.getTask)(index);

    (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.changeTask)(index,'strike',task.strike ? false : true);
...
function removeTask(id){
    ...
    (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.deleteTask)((0,_tasks__WEBPACK_IMPORTED_MODULE_0__.findTask)(id));
    (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.saveTaskList)();
    (0,_tasks__WEBPACK_IMPORTED_MODULE_0__.showTasks)();
...
/* harmony export */   "saveTabList": () => (/* binding */ saveTabList),
/* harmony export */   "clearTabs": () => (/* binding */ clearTabs),
...
const tab = (name) => {
    ...
    const remove = (id) => {
        ...
        ;(0,_tasks__WEBPACK_IMPORTED_MODULE_0__.deleteTasks)(name);
...
function getTaskList(newTaskList){
...
function showTasks(){
    ...
    taskList.forEach(element => {
        ...
        if(element.inTab == (0,_tabs_js__WEBPACK_IMPORTED_MODULE_0__.getTab)()){
...
function newTask(){
    ...
    let newTask = createTask('','','','',(0,_tabs_js__WEBPACK_IMPORTED_MODULE_0__.getTab)(),'false');
    addTask(newTask);
    showTasks();
...
if(!localStorage.getItem('tabList')) {
  ...
  (0,_tabs_js__WEBPACK_IMPORTED_MODULE_1__.newTab)("main");
  //something else here later
} else{
  (0,_tabs_js__WEBPACK_IMPORTED_MODULE_1__.getTabList)(localStorage.getObj('tabList'));
...
//set stored tasklist otherwise
  ...
  (0,_tasks__WEBPACK_IMPORTED_MODULE_2__.getTaskList)(localStorage.getObj('taskList'));
...
(0,_tabs_js__WEBPACK_IMPORTED_MODULE_1__.showTabs)();
